...
<body>
	...
	<div class="w3-container">
		<div class="w3-bar w3-black">
			...
			<button class="w3-bar-item w3-button tablink"
				onclick="openCity(event,'Singapore')">Delete Student Info</button>
			<button class="w3-bar-item w3-button tablink"
							...
							<form name="my-form" onsubmit="return validform()"
								...
								<div class="form-group row">
									<label for="present_address"
										class="col-md-4 col-form-label text-md-right">Father's
										Name</label>
									<div class="col-md-6">
								...
								<div class="form-group row">
									<label for="present_address"
										class="col-md-4 col-form-label text-md-right">Mother's
										Name</label>
									<div class="col-md-6">
								...
								<div class="form-group row">
									<label for="permanent_address"
										class="col-md-4 col-form-label text-md-right">Default
										Password</label>
									<div class="col-md-6">
	...
	<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
						<div class="card-header">Insert New Result(Perform this
							after Adding Student Info)</div>
						<div class="card-body">
							<form name="my-form" onsubmit="return validform()"
								...
								<div class="form-group row">
									<label for="email_address"
										class="col-md-4 col-form-label text-md-right">DAA</label>
									<div class="col-md-6">
								...
								<div class="form-group row">
									<label for="user_name"
										class="col-md-4 col-form-label text-md-right">DBMS</label>
									<div class="col-md-6">
								...
								<div class="form-group row">
									<label for="phone_number"
										class="col-md-4 col-form-label text-md-right">COA</label>
									<div class="col-md-6">
								...
								<div class="form-group row">
									<label for="present_address"
										class="col-md-4 col-form-label text-md-right">Discrete
										Maths</label>
									<div class="col-md-6">
								...
								<div class="form-group row">
									<label for="permanent_address"
										class="col-md-4 col-form-label text-md-right">AMC</label>
									<div class="col-md-6">
								...
								<div class="form-group row">
									<label for="permanent_address"
										class="col-md-4 col-form-label text-md-right">Communication
										Skills</label>
									<div class="col-md-6">
			...
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
						...
						<div class="card-body">
							<form name="my-form" onsubmit="return validform()"
								action="deleteStudent.jsp" method="post">
								<div class="form-group row">
									<label for="full_name"
										class="col-md-4 col-form-label text-md-right">Branch</label>
									<div class="col-md-6">
										<input type="text" class="form-control" name="branch">
									</div>
								</div>
